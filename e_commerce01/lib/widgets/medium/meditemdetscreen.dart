...
class medItemDetScreen extends StatefulWidget {
  ItemModel itemModel;
   medItemDetScreen({Key? key,required this.itemModel}) : super(key: key);

  @override
  State<medItemDetScreen> createState() => _medItemDetScreenState();
}

class _medItemDetScreenState extends State<medItemDetScreen> {
  var w;
  var h;
